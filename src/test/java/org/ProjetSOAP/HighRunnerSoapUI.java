...
public class HighRunnerSoapUI {

	    private String testCaseName;
	    private static String soapuiProjectName = "C:\\Users\\formation\\Documents\\SquashTA-1.10.0-RELEASE-workspace\\ProjetSOAP\\src\\test\\resources\\NOAA-SOAP-soapui-project.xml";

	    public HighRunnerSoapUI(String testCaseName) {
	    ...
	    public static Collection<String[] > getTestCases() throws XmlException, IOException, SoapUIException {
	        ...
	        WsdlTestSuite wsdlTestSuite = soapuiProject.getTestSuiteByName("LatLonListTestSuite");
	    ...
	    public static boolean runSoapUITestCase(String testCase) throws XmlException, IOException, SoapUIException {
	        ...
	        WsdlProject soapuiProject = new WsdlProject(soapuiProjectName);
	        WsdlTestSuite testSuite = soapuiProject.getTestSuiteByName("LatLonListTestSuite");
	        if (testSuite == null) {
